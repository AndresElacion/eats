...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-black text-sm font-medium leading-5 text-white focus:outline-none focus:border-black transition duration-150 ease-in-out'
